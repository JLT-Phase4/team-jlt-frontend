        ...
        <>
          <div className='flex-col'>
            <div style={{ maxWidth: '1250px', marginTop: '100px', marginLeft: '45px', marginRight: '45px' }} className='flex'>
              ...
              <div>
                <div className='avatar-image' style={(userProfile.avatar === undefined || userProfile.avatar === '' || userProfile.avatar === null) ? { backgroundImage: `url(${AVATAR})` } : { backgroundImage: `url(${userProfile.avatar})` }} />
              ...
              ? <div style={{ minWidth: '100%' }}>
                <div className='flex-col'>
                  ...
                  {showSummary && userProfile.assignments.length > 0
                    ?
                    // <div key={userProfile.pk} className='flex-col'>
